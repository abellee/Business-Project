package modules
{
	...
	public class IndexCover extends Sprite
	{
		
		private var indexFrame:IndexFrame = new IndexFrame();
		...
		//０　：　什么都没有（我们没有版权播，你遇到这种影片的话，当鼠标移上去就不要显示那个播放按扭，相当于不能播的）
		//1　：　标清版
		//２　：　		高清版
		//３：　同时有两种版本。
		...
		public function set description(str:String):void{
			...
			indexFrame.maskMC.disTxt.text = str;

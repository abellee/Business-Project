...
;(function($, undefined) {
	...
	function Confirm(options) {
		...
		if (!$modal.length) {
			var yesLabel = this.options.yesLabel;
			yesLabel = yesLabel ? yesLabel : "确 定";
			var noLabel = this.options.noLabel;
			noLabel = noLabel ? noLabel : "取 消";
			$modal = $('<div class="modal fade" id="' + this.options.target.substr(1) + '" tabindex="-1" role="dialog" aria-hidden="true"><div class="modal-dialog"><div class="modal-content"><div class="modal-body inner"/><div class="modal-footer"><a class="btn cancel" href="#" data-dismiss="modal">' + noLabel + '</a> <a href="#" class="btn btn-danger" data-action="1">' + yesLabel + '</a></div></div></div></div>').appendTo(this.options.appendTo).hide();
